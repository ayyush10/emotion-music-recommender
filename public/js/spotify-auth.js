const SpotifyAuth = (() => {
  ...
  function getRedirectUri() {
    // Resolves "./callback.html" relative to the current page URL
    const href = new URL("./callback.html", window.location.href).href
    return href
  }
  ...
  async function buildAuthorizeUrl() {
    ...
    console.log("[v0] Authorize URL:", url.toString())
    console.log("[v0] Using redirect_uri for authorize:", redirectUri)
